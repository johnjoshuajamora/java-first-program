...
public class BestLoanRates {
    public static final Map<Integer, Float> bestRates = new Map.of(1, 5.50f, 2, 3.45f, 3, 2.67f);
    ...
    public static void main( String[] args ) {
        ...
        LoanRates loanRates = new LoanRates();
        float bestRate = loanRates.getRates(loanTermInYears);
